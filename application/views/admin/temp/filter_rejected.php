...
<div id="content">
    <h2>Report &raquo; Rejected Upload </h2>
  

    <dl>           
    <dt>
    Filter By Date:<br />
			<form method="post" id="add_product_form" enctype="multipart/form-data" action="<?php echo site_url('lifebuoy_adm/temp_upload/rejected_csv');?>">
...
function download_page(){
	...
	var url='<?php echo site_url('lifebuoy_adm/temp_upload/download_rejected_form')?>/'+start_date+'/'+end_date;	
	window.open(url);
}
</script>

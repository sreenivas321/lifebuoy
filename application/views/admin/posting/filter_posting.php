...
<div id="content">
    <h2>Report &raquo; Approved</h2>
  

    <dl>           
    <dt>
    Filter By Date:<br />
			<form method="post" id="add_product_form" enctype="multipart/form-data" action="<?php echo site_url('lifebuoy_adm/posting/csv');?>">
    ...
    <dl>
        <dd></dd>
       <dt><input type="submit" id="add_product_submit" class="defBtn" value="Submit"/> <input type="button" class="defBtn" value="Back" onclick="window.location='<?php echo site_url('lifebuoy_adm/posting');?>';" /></dt>
    </dl>
...
function download_page(){
	...
	var url='<?php echo site_url('lifebuoy_adm/posting/download_csv_form')?>/'+start_date+'/'+end_date;	
	window.open(url);
}
</script>

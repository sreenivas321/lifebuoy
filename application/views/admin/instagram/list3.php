<div id="content">
    ...
    <div id="submenu">
        <ul>  
            <li>  
			<?php if($prev_link!=1){?>
            <a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/kompakberhijab').'/'.$prev_link.'/01';?>"><span>PREV</span></a>
            <?php }?>
			<?php if($pagination!=11){?><a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/kompakberhijab/01').'/'.$pagination;?>"><span>NEXT</span></a><?php }?>       
            </li>  	
        </ul>
    </div>
...
<div id="submenu">
        <ul>  
            <li>  
			<?php if($prev_link!=1){?>
            <a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/xllove').'/'.$prev_link.'/01';?>"><span>PREV</span></a>
            <?php }?>
			<?php if($pagination!=11){?><a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/xllove/01').'/'.$pagination;?>"><span>NEXT</span></a><?php }?>       
            </li>  	
        </ul>
    </div>    
</div>

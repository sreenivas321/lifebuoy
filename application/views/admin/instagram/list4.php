<div id="content">
    ...
    <div id="submenu">
        <ul>  
            <li>  
			<?php if($prev_link!=1){?>
            <a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/rayakanlebaran').'/'.$prev_link.'/01';?>"><span>PREV</span></a>
            <?php }?>
			<?php if($pagination!=11){?><a class="defBtn" href="<?php echo site_url('xlselfie_admin/instagram/rayakanlebaran/01').'/'.$pagination;?>"><span>NEXT</span></a><?php }?>       
            </li>  	
        </ul>
    </div>
